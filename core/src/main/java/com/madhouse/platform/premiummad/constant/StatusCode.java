...
public enum StatusCode {
	...
	SC20208(20208, "已删除重复广告位映射信息，请重新创建"), //
	...
	SC20403(20403, "Policy名称不能重复"), //
	SC20404(20404, "请添加广告位"), //
	SC20405(20405, "请添加需求方"), //
	SC20406(20406, "PDB和PD策略有且只能有一个DSP"), //
	SC20407(20407, "广告位的售卖单价不能低于其底价"), //
	SC20408(20408, "请提供广告位自身的底价"), //
