...
public class MaterialController {
	...
	public ResponseDto<Void> upload(@RequestBody @Valid MaterialDto materialDto, @RequestParam(value = "dspId") String dspId, @RequestParam(value = "token") String token) throws Exception {
