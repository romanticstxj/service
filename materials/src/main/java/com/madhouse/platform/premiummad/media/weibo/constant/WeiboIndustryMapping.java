 ...
 * 与新浪微博行业映射 TODO
 */
public enum WeiboIndustryMapping {
	AI1001(1001, 11),
	AI1002(1002, 11),
	AI1003(1003, 11),
	AI1004(1004, 11),
	...
	WeiboIndustryMapping(int industryId, int mediaIndustryId) {
	...
	public static int getMediaIndustryId(int industryId) {
		for (WeiboIndustryMapping item : WeiboIndustryMapping.values()) {
			if (item.getIndustryId() == industryId) {
				return item.getMediaIndustryId();
			}
		}
		// 否则返回其他
		return WeiboIndustryMapping.AI17001.getMediaIndustryId();
	}
