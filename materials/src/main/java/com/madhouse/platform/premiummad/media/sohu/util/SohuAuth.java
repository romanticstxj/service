package com.madhouse.platform.premiummad.media.sohu.util;
...
/**
 * 使用方式 sohuAuth.setHttpMethod("POST").setApiUrl("xxx").setParamMap(paramMap).
 * buildRequest(); 参数为空时不用setParamMap
 */
@Component
public class SohuAuth {
	 ...
	 * @return this
	 */
	public SohuAuth setHttpMethod(final String httpMethod) {
	 ...
	 * @return this
	 */
	public SohuAuth setApiUrl(final String apiUrl) {
		this.apiUrl = apiUrl;
		return this;
	}
	 ...
	 * @return this
	 */
	public SohuAuth setParamMap(final Map<String, Object> paramMap) {
