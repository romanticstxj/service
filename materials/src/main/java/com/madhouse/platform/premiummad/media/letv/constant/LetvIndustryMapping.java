 ...
 * 与乐视行业映射
 */
public enum LetvIndustryMapping {
	AI1001(1001, 11),
	AI1002(1002, 11),
	AI1003(1003, 11),
	AI1004(1004, 11),
	...
	LetvIndustryMapping(int industryId, int mediaIndustryId) {
	...
	public static int getMediaIndustryId(int industryId) {
		for (LetvIndustryMapping item : LetvIndustryMapping.values()) {
			if (item.getIndustryId() == industryId) {
				return item.getMediaIndustryId();
			}
		}
		// 否则返回其他
		return LetvIndustryMapping.AI17001.getMediaIndustryId();
	}
