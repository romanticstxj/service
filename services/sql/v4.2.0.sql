...
/*Data for the table `mad_dict_layout` */
insert  into `mad_dict_layout`(`code`,`name`) values (101,'横幅'),(102,'焦点图'),(111,'插屏'),(112,'全屏'),(121,'开屏图片'),(131,'开机图片'),(132,'关机图片'),(201,'前贴'),(202,'中贴'),(203,'后贴'),(211,'悬浮/暂停'),(221,'开机视频'),(222,'关机视频'),(231,'开屏视频'),(300,'图文信息流'),(311,'视频信息流');
